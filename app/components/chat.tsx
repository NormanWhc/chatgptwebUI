...
export function Chat() {
  ...
  const likeThisMes = (botMessageId: number) => {
    const userIndex = findLastUserIndex(botMessageId);
    console.log(botMessageId, userIndex, "botMessageId");
  };
  const dislikeThisMes = (botMessageId: number) => {
                      ...
                      <div className={styles["chat-message-top-actions"]}>
                        {message.streaming ? (
                          ...
                          <>
                            <div
                              className={styles["chat-message-top-action"]}
                              onClick={() => likeThisMes(message.id ?? i)}
                            >
                              赞
                            </div>
                            <div
                              className={styles["chat-message-top-action"]}
                              onClick={() => dislikeThisMes(message.id ?? i)}
                            >
                              踩
                            </div>
